/**
 * Simple, elegant logging for TypeScript/JavaScript frontends.
 *
 * Provides structured logging with proper categorization, context,
 * and development-friendly output. KISS principle applied!
 */
